...
=begin
url="http://api.trackingmore.com/v2/trackings/cuckooexpress/RP325552475CN/en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/cuckooexpress/RP325552475CN"
...
postData = {"tracking_number": "RP325552475CN","carrier_code":"cuckooexpress","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = {"tracking_number":"RP325552475CN","carrier_code":"cuckooexpress","update_carrier_code":"china-ems"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"carrier_code":"cuckooexpress","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"tracking_number":"RP325552475CN","carrier_code":"cuckooexpress"},{"tracking_number":"LZ448865302CN","carrier_code":"china-ems"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
